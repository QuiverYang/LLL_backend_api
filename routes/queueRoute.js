...
router.post('/setVisitorToEmpty',queueController.setVisitorToEmpty);//leadline/admin/queue/setVisitorToEmpty
...
router.get('/getAllQueue',queueController.getAllQueue);
